**Introduction**
    ...
    Tertio, c’est aussi une opportunité pour nous, étudiants. Une opportunité car ce challenge est l’occasion pour nous de mettre en œuvre un projet concret qui doit répondre à des attentes bien précises. Ici, nous nous retrouvons au croisement de plusieurs _skills_ que nous devrons savoir valoriser lors de notre grand saut au sein du marché du travail. Le Challenge Data c’est également des relations : un travail d’équipe inégalé couplé à un relationnel d’enfer avec notre collectivité. Encore une fois, ici c’est l’occasion d’échanger, de trouver des solutions, de valoriser et faire briller la production collective afin que le Pôle Marennes Oléron puisse, à l’avenir, rendre l’ouverture de ses données plus aisée.
...
Wishlist
   ...
   <td>Difficultés pour identifier une wishlist individualisée pour le traitement spécifique des données relatives aux fonds européens (LEADER, DLAL FEAMP).
   </td>
  </tr>
  <tr>
   <td>Casses-tête
<p>
 Plateforme Pigma
   ...
   <td>Difficultés d’adapter les attentes de la plateforme vis-à-vis du format (restitution par cartes) au regard des données à traiter (attribution de fonds sans données géographiques) peu adaptées à ce modèle de restitution par cartes. 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
...
Analyse de la base de données 
   ...
   <td>Difficultés pour identifier clairement les fichiers des fonds du fait du nombre d’acronymes. 
   </td>
  </tr>
  <tr>
   <td> Réussite
...
Usage du questionnaire
   ...
   <td>Identifier la maturité de la collectivité vis-à-vis de l’ouverture des données, de leur connaissance des enjeux attenants aux données
<p>
Maturité : palier 2
   </td>
  </tr>
...
Bonne humeur
   ...
   <td>Le groupe se porte bien, l’esprit d’équipe commence à se ressentir
   </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
   ...
   <td>Organigramme : grâce à M. R, l’organigramme des données a pu être complété
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>Plateforme PIGMA : M. R a répondu à nos inquiétudes par rapport aux attentes de la plateforme. Nous allons pouvoir l’utiliser pour le jour 4.
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Comme au jour 1, l’analyse de la base de données reste compliquée.
<p>
Il est compliqué de comprendre ce qui a abouti, le manque de standardisation rend difficile la compréhension par une personne extérieure au PETR.
<p>
L’analyse de la base de données est de plus peu aisée du fait d’un manque de compréhension du fonctionnement des fonds en eux-mêmes et de leur mode d’attribution.
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Le standard qui n’est pas vraiment adapté aux données reçues
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>La recherche de standards alternatifs et d’exemples de données déjà publiée par d’autres collectivités (peu d’exemples)
   </td>
  </tr>
</table>
...
* Jeux des projets subventionnés dans le cadre de LEADER
* Jeux des projets subventionnés dans le cadre de FEAMP
...
<table>
  ...
  <tr>
   ...
   <td>La question des dates de signatures qui ne sont pas renseignées de la même façon dans les jeux de données des deux programmes. Question que nous avons résolue avec l’aide de S.R
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>La standardisation des données a été difficile, notamment au niveau de la mise en forme où nous avons rencontré des coquilles dans les bases de données fournies par le PETR, notamment au regard de l’ordre des projets au sein des fiches actions par exemple.
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>Nous avons fini par réussir à standardiser les données
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>Succès de notre base de données lors des vérifications manuelles. 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Les dates et leur référencement et les échanges autour de ça par email. 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>SOS il n’y a plus de Schoko-bons
   </td>
  </tr>
</table>
...
* Temps de mise en qualité du jeu de données : 3 heures
* Nombre de personne aillant travaillé à la mise en qualité du jeu de donnée : 5
* Outils recommandés : 

        [https://publier.etalab.studio/](https://publier.etalab.studio/) : pour préparer, compléter et vérifier vos jeux de données


        …

* Les principales difficultés rencontrées : Problème de cohérence dans les dates de signature des conventions pour LEADER. Problème d’ordre dans lesquels les projets étaient écrits donc il a fallu les réorganiser avant de les exploiter pour FEAMP
* Globalement nous n’avons pas eu trop de mal à mettre en qualité les données. Nous avions des bases de données plutôt claires et bien organisées malgré les quelques problèmes évoqués précédemment. Les difficultés que nous avons rencontrées sont donc résolues ou en passe de l’être. Cependant le travail a été un peu fastidieux à réaliser. 
...
![alt_text](images/image3.png "image_tooltip")
    ...
    _Image : Captures de la plateforme Pigma envoyées par S.R et complétées avec les métadonnées à publier_
...
<em>Image : nous avons appris à réaliser des tableaux croisés dynamiques</em> </p>


_Un essai réussi de data visualisation sur le site Datawrapper_
...
<table>
  ...
  <tr>
   ...
   <td>Achèvement des deux bases de données. 
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>Rédaction du plan de communication. 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Le plan de communication a été compliqué à élaborer : d’une part le template proposé par l’équipe datactivist ne nous paraissait pas clair ni très pertinent, et d’autre part la collectivité communique peu de manière générale en dehors de son site internet, nous avons donc fait des propositions. 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Difficultés à réunir toutes les informations nécessaires à l’élaboration des fiches de description, notamment 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>N’étant pas concernés par la publication sur data.gouv.fr il a fallu nous familiariser un peu avec la plateforme Pigma (avec l’aide précieuse de S.R), et contrairement aux autres groupes nous ne pouvons pas publier nos données aujourd’hui. Nous attendons donc demain de voir si S.R nous accompagne pour la publication officielle ou s’il le fera plus tard de son côté. 
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Nous avons eu des difficultés à réaliser des data visualisations en fin de journée, mais nous sommes parvenus après différents essais sur différents sites à obtenir des premiers modèles de data visualisations. 
   </td>
  </tr>
</table>
    ...
    [https://docs.google.com/spreadsheets/d/1hvERHIWNFlPor5gg0-QNf_rw3wnLz_eEelWeQIueduk/edit#gid=2137311547](https://docs.google.com/spreadsheets/d/1hvERHIWNFlPor5gg0-QNf_rw3wnLz_eEelWeQIueduk/edit#gid=2137311547)


    [https://docs.google.com/spreadsheets/d/1NUThFM1Yw7TbpjjkTqG6hlh9hNNZLjD21brVBrYVhJo/edit#gid=0](https://docs.google.com/spreadsheets/d/1NUThFM1Yw7TbpjjkTqG6hlh9hNNZLjD21brVBrYVhJo/edit#gid=0)
...
![alt_text](images/image6.png "image_tooltip")
    ...
    [https://docs.google.com/document/d/1E02TjUrFJwdSMfLQ6LJMD8bcGtj31S3Z/edit?usp=share_link&ouid=105743968243848976039&rtpof=true&sd=true](https://docs.google.com/document/d/1E02TjUrFJwdSMfLQ6LJMD8bcGtj31S3Z/edit?usp=share_link&ouid=105743968243848976039&rtpof=true&sd=true)
...
_Les derniers moments conviviaux sur Gathertown_
...
_Mise en ligne des bases de données sur PIGMA accompagnés par Stéphane_
...
<table>
  ...
  <tr>
   ...
   <td>Nous avons rencontré des difficultés à afficher la médiane des montants d’aide répartis par objectifs thématiques pour la datavisualisation “boîte à moustache”, et pour réaliser les graphiques qui se sont montrés un peu récalcitrants.
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>On a réussi à réaliser les diagrammes à moustache, et les diagrammes à barres sur datawrapper au final.
   </td>
  </tr>
  <tr>
   <td>Casses-tête
   </td>
   <td>Les dates et les montants ne correspondaient pas dans le fichier excel.
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>Nous avons reçu les codes d’accès à Pigma ce qui nous a permis d’y publier les deux jeux de données FEAMP et LEADER.
   </td>
  </tr>
  <tr>
   <td>Réussite
   </td>
   <td>La présentation finale s’est bien passée, nous avons eu des retours enthousiastes.
   </td>
  </tr>
</table>
    ...
    **CONCLUSION**
    ...
    _Dans cette partie, vous aurez à faire un double bilan : celui de la commune, celui de votre groupe. Combien de jeux de données ont été ouverts ? Quels ont été les freins et les leviers de cette ouverture de données ? Et à vous en tant qu’étudiants en sciences politiques, que vous a appris cette semaine ? Que vous a-t-elle apporté ? Quels ont été vos plus gros casse-têtes et vos plus belles réussites dans l’ouverture des données ?_


    Deux jeux de données ont été ouverts à l’issue de cette semaine du data challenge sur les deux jeux de données fournis initialement par la collectivité. Ces 2 jeux de données correspondent aux bases de données transmises par le PETR en début de semaine : le premier portant sur le fond LEADER et le deuxième sur le fond FEAMP.
