Cette semaine de cours sera consacrée au Challenge Data et représente une semaine importante dans notre parcours de 4ème année.  Après la réunion de briefing de 9h, notre collectivité nous est attribuée. Il s’agit de  la commune de Sailly-Lez-Lannoy. Un village de 1987 habitants dans la région Haut de France et dans le département du Nord. Cette collectivité est rattachée à la Métropole Européenne de Lille. Il s’agira donc pour notre équipe de récupérer leurs données et les publier sur le portail open data de la MEL. 
    ...
    **<span style="text-decoration:underline;">JOUR 1 – DIAGNOSTIC</span>**
...
3. Combien d’agents comportent votre collectivité ? _14 _
...
7. Quels freins ? / Quels leviers à la démarche open data au sein de la collectivité ? _Les freins incarnent la taille de la commune, qui est petite et rurale, ainsi que les conseillers qui appartiennent à une génération non familière avec l'open data _
...
17. Dans quelle mesure votre organisation utilise-t-elle des données ouvertes (en provenance de votre organisation ou d'un tiers) ? _Nous n'utilisons pas de données ouvertes_
...
**<span style="text-decoration:underline;">Résumé : </span>**
...
<table>
  ...
  <tr>
   ...
   <td>Planification du rendez-vous et prise de contact avec notre interlocuteur. Échanges de mails fructueux, délais rapides. 
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Évaluation de la maturité open data via le questionnaire Airtable. Interlocuteur aux réponses claires, qui maîtrise le sujet. 
   </td>
  </tr>
  <tr>
   <td> Casses-tête
   </td>
   <td>Demande hors catalogue de la wishlist qui implique une identification des attentes plus complexe, d’autant plus que le travail en amont communiqué est relativement complet. 
<p>
Résultat : moins de recherche de données de notre côté mais davantage de manipulation donc probablement plus chronophage
   </td>
  </tr>
  <tr>
   <td>  
  ...
  <tr>
    ...
    **<span style="text-decoration:underline;">JOUR 2 – IDENTIFICATION</span>**
...
<table>
  ...
  <tr>
   ...
   <td>Ne pas avoir de template car la demande est spécifique et hors wishlist => besoin de faire un benchmark sur les métropoles de Lille, Lyon, Marseille etc afin de repérer le modèle template le plus standard. 
   </td>
  </tr>
  <tr>
   <td> Casses-tête
   </td>
   <td><strong>L’objectif de notre interlocuteur est vaste, nous ne savons pas quelles données prioriser pour répondre à son besoin d’analyse des besoins sociaux de la commune</strong>. C’est pourquoi notre réunion a grandement aidé. Désormais les objectifs sont clairs : nous nous focalisons à l’échelle de la commune, sur trois thèmes (population, logement et famille) et les résultats de l’enquête communiqués ne sont pas à exploiter. 
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Nous avons réussi à trouver la source des données, puis nous les avons ressortis sous forme d’excel. 
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>La journée 2 est globalement une réussite car nous avons pu remplir la wishlist 
   </td>
  </tr>
  <tr>
   <td>  
...
<table>
  ...
  <tr>
   ...
   <td>Manque de connexion (wifi) lors de la réunion avec notre interlocuteur  
   </td>
  </tr>
  <tr>
   <td> Casses-tête
   </td>
   <td>Filtrer les fichiers de données pour les 95 communes de la métropole de Lille => recherche d’un tuto sur microsoft google : <a href="https://support.microsoft.com/fr-fr/office/filtrer-%C3%A0-l-aide-de-crit%C3%A8res-avanc%C3%A9s-4c9222fe-8529-4cd7-a898-3f16abdff32b?fbclid=IwAR1VPYDT08AIQbAHZbDkGF2WXNPCJ536FxZp4Jz2dFYcbycfApxgaPs2qO4">https://support.microsoft.com/fr-fr/office/filtrer-%C3%A0-l-aide-de-crit%C3%A8res-avanc%C3%A9s-4c9222fe-8529-4cd7-a898-3f16abdff32b?fbclid=IwAR1VPYDT08AIQbAHZbDkGF2WXNPCJ536FxZp4Jz2dFYcbycfApxgaPs2qO4</a> Mais tutoriel ne résulte qu’en échec. 
   </td>
  </tr>
  <tr>
   <td> Casses-tête
   </td>
   <td>La MEL ne souhaite pas publier nos données. Par conséquent, nous ne savons pas si ce que nous avons réalisé a été utile
   </td>
  </tr>
  <tr>
   <td> Casses-tête
   </td>
   <td>Nous quittons l’IEP avec plusieurs doutes et nous ne savons pas encore ce que nous devrons réaliser demain. 
   </td>
  </tr>
  <tr>
   <td>  
    ...
    **<span style="text-decoration:underline;">JOUR 4 – PUBLICATION</span>**
...
_Fiche descriptive du jeu de données sur la population _
...
<table>
  ...
  <tr>
   ...
   <td>Nous avons réussi à réaliser les fiches descriptives des jeux de données sans trop de difficultés. 
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Nous avons publié nos premiers jeux de données sur la plateforme data.gouv liés au logement et à la population
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Nous avons même eu le temps de publier un jeu de données supplémentaire qui sera utilisé par la métropole de Lille, il s’agit de subventions accordées par la commune aux associations. 
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Nous avons beaucoup avancé le plan de communication et réalisé quelques data visualisation
   </td>
  </tr>
  <tr>
   <td>  
...
**<span style="text-decoration:underline;">JOUR 5 – VALORISATION</span>**


    **Dans cette partie, vous aurez à présenter la réalisation des datavisualisations en pratique : quels ont été vos outils, vos choix de conceptions et les étapes suivies pour aboutir au résultat.**


    **Pièces à joindre : datavisualisations réalisées et lien vers le document décrivant leur contexte**
...
_Quelques exemples des slides de notre stratégie de communication. _
...
<table>
  ...
  <tr>
   ...
   <td>Nous avons bien réussi à faire et à sélectionner les data visualisations que nous souhaitions garder dans notre présentation
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Bilan de la semaine avec Céline sur les points positifs et à améliorer de ce challenge data.
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Conclusion du Power Point pour la présentation
   </td>
  </tr>
  <tr>
   <td> Réussite
   </td>
   <td>Superbe réunion de clôture avec Guillaume afin de lui présenter notre travail
   </td>
  </tr>
  <tr>
   <td> Casses-tête
   </td>
   <td>Quelques difficultés pour mettre en place les graphiques car nos jeux de données étaient très fournis. 
   </td>
  </tr>
</table>
